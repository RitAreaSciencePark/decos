...
def add_laboratory_field(apps, schema_editor):
    Group = apps.get_model("auth", "Group")  # Get the Group model dynamically
    schema_editor.execute(
        ...
        BEGIN
            IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
                          ...
                          AND column_name = 'laboratory') THEN
                ALTER TABLE auth_group ADD COLUMN laboratory BOOLEAN DEFAULT FALSE;
            END IF;
        END $$;
    """
    )
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('minio_acces_key', models.CharField(blank=True, max_length=128, null=True)),
                ('minio_secret_key', models.CharField(blank=True, max_length=128, null=True)),
            ],
            options={
                'db_table': 'api_tokens',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('minio_base_url', models.CharField(blank=True, help_text='Minio endpoint', max_length=255, verbose_name='MinIo Endpoint')),
            ],
            options={
                'abstract': False,
            },
